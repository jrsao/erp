 ...
 */
class Version20150427230441 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE Address (id INT AUTO_INCREMENT NOT NULL, state_id INT DEFAULT NULL, city_id INT DEFAULT NULL, country_id INT DEFAULT NULL, person_id INT DEFAULT NULL, streetNumber INT NOT NULL, street VARCHAR(255) NOT NULL, zipCode VARCHAR(15) DEFAULT NULL, INDEX IDX_C2F3561D5D83CC1 (state_id), INDEX IDX_C2F3561D8BAC62AF (city_id), INDEX IDX_C2F3561DF92F3E70 (country_id), INDEX IDX_C2F3561D217BBB47 (person_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE PhoneNumber (id INT AUTO_INCREMENT NOT NULL, person_id INT DEFAULT NULL, contact VARCHAR(255) NOT NULL, type VARCHAR(255) DEFAULT NULL, phone_number VARCHAR(255) NOT NULL, INDEX IDX_6EC20C33217BBB47 (person_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
